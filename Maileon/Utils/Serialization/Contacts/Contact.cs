...
namespace Maileon.Utils.Serialization.Contacts
{
    ...
    public class XmlContact
    {
        ...
        public List<XmlStandardField> StandardFields { get; set; }

        /// <summary>
        /// The custom contact fields
        /// </summary>
        [XmlArray("custom_fields"), XmlArrayItem("field")]
        public List<XmlCustomField> CustomFields { get; set; }
        ...
        public XmlPermissions Permission { get; set; }
        ...
        public XmlContact() { }
        public XmlContact(string email) 
        {
            this.Email = email;
            this.Permission = new XmlPermissions(); ;
            this.StandardFields = new List<XmlStandardField>();
            this.CustomFields = new List<XmlCustomField>();
